...
/**
 * Voltara-styled dropdown for expense categories. Mirrors BillCategoryPicker /
 * ExpenseEntityPicker: inline add + per-row delete (blocked when the
 * category is in use by existing expenses).
 */
export function ExpenseCategoryPicker({ value, onChange }: Props) {
